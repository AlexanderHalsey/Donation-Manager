...
def file_storage_check(donations):
	for donation in donations:
		if donation.pdf == True:
			...
			donation_file_name = str(donation.id) + "_" + donation.contact.profile.name + "_" + str(donation.date_donated) + ".pdf"
			if donation_file_name not in files:
				...
				donation.pdf_receipt = pdf_receipt(text_variables, images, str(path) + "/" + donation_file_name)
				donation.save()
	return
...
def pdf_receipt(text, images, donation_file_name):
